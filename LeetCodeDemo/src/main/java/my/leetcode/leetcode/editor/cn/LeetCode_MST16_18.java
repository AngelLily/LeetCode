...
public class LeetCode_MST16_18{
    public static void main(String[] args) {
        Solution solution = new LeetCode_MST16_18().new Solution();
        System.out.println(JSON.toJSONString(solution.patternMatching("abba","dogcatcatdog")));
    }
